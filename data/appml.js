...
function AppML(container, appsrc, appmlname) {
    ...
    this.translate = function (txt) {
      ...
      patt = /APPML_MESSAGE_RECORD_UPDATED/g; txt = txt.replace(patt, "Registro atualizado");      
      patt = /APPML_MESSAGE_RECORD_ADDED/g; txt = txt.replace(patt, "Registro Inserido");
      patt = /APPML_MESSAGE_RECORD_DELETED/g; txt = txt.replace(patt, "Registro Excluido");
    ...
    this.deleteRecord = function () {
        var s = window.confirm("Tem certeza que quer apagar este registro?");
        if (s === false) {return -1; }
